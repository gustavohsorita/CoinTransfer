...
server.get('/hello', async (req, resp, next) => {
    ...
    const main = async () => {
        ...
        var myAddress = "0xD3f2a22cEfC0f8eD3B468De2E511822aA2C66D10";

        // Who are we trying to send this token to?
        var destAddress = "0x84a569537Ee12E62793DaF9A366E26a692Fc8508";
        ...
        var abiArray = JSON.parse(fs.readFileSync('C:/Github/SnakeZone/Assets/WebGLTemplates/Web3GL-2020/abi.json', 'utf-8'));

        console.log("D");

        // This is the address of the contract which created the ERC20 token
        var contractAddress = "0xfAFB12dfa837b2FA4d66213609e3fB6490850866";
        ...
        var privKey = new Buffer('cfbd47d07bb361ce93488edc9e3e5746c1613ebeb76dea4579726a3761b04700', 'hex');
